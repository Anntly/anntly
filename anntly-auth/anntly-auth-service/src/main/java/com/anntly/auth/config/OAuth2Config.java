...
public class OAuth2Config extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    private MyUserDetailService myUserDetailService; // 用于刷新token
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory().withClient("AnWebApp")
                ...
                .accessTokenValiditySeconds(1200) // token过期时间
                .refreshTokenValiditySeconds(2400); // refreshToken过期时间
    }
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
        ...
        endpoints.tokenStore(tokenStore()).tokenEnhancer(enhancerChain)
                .authenticationManager(authenticationManager).userDetailsService(myUserDetailService);
    }
